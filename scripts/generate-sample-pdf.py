...
def build_pdf():
    ...
    rounded_box(pdf, 34, 122, 350, 156, GREEN_SOFT, stroke=HexColor("#BFD2C5"), radius=13)
    pdf.setFillColor(AMBER)
    ...
    pdf.setLineWidth(0.8)
    pdf.line(52, 191, 362, 191)
    pdf.line(52, 150, 362, 150)

    rounded_box(pdf, 404, 122, 174, 156, BLUE_SOFT, stroke=HexColor("#BDD2DB"), radius=13)
    label(pdf, "Remember", 422, 244, BLUE)
    pdf.setFillColor(INK)
    pdf.setFont("Helvetica-Bold", 14)
    pdf.drawString(422, 217, "Go to high ground")
    wrapped_text(pdf, "If officials ask you to leave, take your emergency bag and move before routes become unsafe.", 422, 197, 138, size=8.2, leading=11, color=MUTED)
    pdf.setStrokeColor(BLUE)
    pdf.setLineWidth(2)
    pdf.line(426, 146, 458, 166)
    pdf.line(458, 166, 482, 151)
    pdf.line(482, 151, 520, 188)
    pdf.setFillColor(BLUE)
    pdf.circle(520, 188, 4, fill=1, stroke=0)
