...
export const copy = {
  en: {
    ...
    fontSize: "Text size", resetFontSize: "Reset text size", keepOriginal: "Keep original - do not translate", restoreTranslationBlock: "Restore translation block",
  ...
  vi: {
    ...
    fontSize: "Cỡ chữ", resetFontSize: "Đặt lại cỡ chữ", keepOriginal: "Giữ nguyên - không dịch", restoreTranslationBlock: "Khôi phục khối dịch",
