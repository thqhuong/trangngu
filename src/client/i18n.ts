...
export const copy = {
  en: {
    ...
    checking: "Checking your PDF…", pages: "pages", remove: "Remove file", targetLabel: "Translate into",
    ...
    revealView: "Reveal slider", original: "Original", translated: "Translated", reveal: "Translation reveal",
    ...
    fontSize: "Text size", resetFontSize: "Reset text size", autoFontSize: "Auto size", keepOriginal: "Keep original - do not translate", restoreTranslationBlock: "Restore translation block",
    ...
    granularityLabel: "Translation mode", granularityByBlock: "By block", granularityByLine: "By line",
    granularityByBlockHint: "Groups paragraph text into single blocks. Output layout looks cleaner and more natural, but editing individual sentence corrections may affect the whole block.",
    granularityByLineHint: "Translates line by line preserving exact line locations. Gives precise control to edit or adjust font sizes line-by-line, but layout may look slightly uneven.",
    dragHint: "Drag the line across the page to compare",
  },
  vi: {
    ...
    checking: "Đang kiểm tra PDF…", pages: "trang", remove: "Xóa tệp", targetLabel: "Dịch sang",
    ...
    revealView: "Thanh so sánh", original: "Bản gốc", translated: "Bản dịch", reveal: "Mức hiển thị bản dịch",
    ...
    fontSize: "Cỡ chữ", resetFontSize: "Đặt lại cỡ chữ", autoFontSize: "Kích thước tự động", keepOriginal: "Giữ nguyên - không dịch", restoreTranslationBlock: "Khôi phục khối dịch",
    ...
    granularityLabel: "Chế độ dịch", granularityByBlock: "Khối đoạn", granularityByLine: "Từng dòng",
    granularityByBlockHint: "Gộp văn bản thành từng khối đoạn. Bố cục tự nhiên và đẹp mắt hơn, nhưng chỉnh sửa các lỗi nhỏ sẽ áp dụng cho cả khối.",
    granularityByLineHint: "Dịch từng dòng theo đúng vị trí. Dễ dàng tinh chỉnh từng dòng và kích thước chữ, nhưng bố cục tổng thể có thể không đồng đều bằng dịch theo khối.",
    dragHint: "Kéo đường chia ngang qua trang để so sánh",
  },
} as const;
