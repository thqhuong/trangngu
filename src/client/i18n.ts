...
export const copy = {
  en: {
    ...
    reviewPanelBody: "Edit the wording or resize its real PDF text box.", noBlocks: "No text blocks were found on this page.",
  ...
  vi: {
    ...
    reviewPanelBody: "Sửa câu chữ hoặc đổi kích thước hộp chữ thật trong PDF.", noBlocks: "Không tìm thấy khối chữ trên trang này.",
