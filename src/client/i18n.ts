...
export const copy = {
  en: {
    ...
    flagged: "flagged for review", edited: "edits made", expires: "Review session expires", splitView: "Side by side",
    ...
    reviewPanelBody: "Flagged blocks appear first. You can edit any translation.", noBlocks: "No text blocks were found on this page.",
    noReview: "No issues flagged on this page", lowConfidence: "Check this translation", originalText: "Original text",
  ...
  vi: {
    ...
    flagged: "phần cần kiểm tra", edited: "chỉnh sửa", expires: "Phiên xem lại hết hạn lúc", splitView: "Hai bên",
    ...
    reviewPanelBody: "Phần cần chú ý được đưa lên trước. Bạn có thể sửa mọi bản dịch.", noBlocks: "Không tìm thấy khối chữ trên trang này.",
    noReview: "Trang này không có lỗi cần kiểm tra", lowConfidence: "Hãy kiểm tra bản dịch này", originalText: "Nội dung gốc",
